...
namespace FunctionV2
{
    public static class UserApi
    {
        ...
        public static async Task<IActionResult> CreateUser(
            ...
            [Table("Users", Connection = "AzureWebJobsStorage")] IAsyncCollector<UserTableEntity> userTable,
            [Queue("Users", Connection = "AzureWebJobsStorage")] IAsyncCollector<User> userQueue,
            ILogger log)
        {
        ...
        public static IActionResult GetUserById(
            ...
            [Table("Users", "USER", "{id}", Connection = "AzureWebJobsStorage")] UserTableEntity user,
